...
#coleção WPM Fused do CBERS-4A (Resolução de 2 metros)git

search = catalog.search(
    collections=["CB4A-WPM-PCA-FUSED-1"],
    bbox=bbox,
    datetime="2026-08-01/2026-08-30",  # Intervalo amplo para capturar cenas
)
  ...
  for item in items:
    ...
    try:
      with rasterio.open(asset_href) as src:
        ...
        output_filename = "cbers_expandido_30pct.tif"
